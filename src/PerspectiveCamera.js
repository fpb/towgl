...
export class PerspectiveCamera extends Camera {
    constructor(fovy = 90, aspect = 2, near = 0.1, far = 100) {
        ...
        this.matrix.m[2][0] = 0; this.matrix.m[2][1] = 0; this.matrix.m[2][2] = (far + near) / n_f; this.matrix.m[2][3] = 2 * far * near / n_f;
        this.matrix.m[3][0] = 0; this.matrix.m[3][1] = 0.0; this.matrix.m[3][2] = -1; this.matrix.m[3][3] = 1;
    }
